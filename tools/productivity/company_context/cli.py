...
app = typer.Typer(
    ...
    help=(
        "Search or run scoped SQL over company history, Slack DMs, Google Docs, "
        "Granola notes, and configured application sources."
    ),
)
...
def search(
    ...
    source: str | None = typer.Option(
        ...
        "--source",
        help=(
            "Filter by source. Use 'docs' for Google Docs, 'granola' for Granola "
            "notes, or an operator-configured application source."
        ),
    ),
